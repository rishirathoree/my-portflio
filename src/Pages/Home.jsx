...
const Home = () => {
  ...
  return (
    ...
    <div onClick={()=>{setShowProjects(true)}} style={{left:`${mousePosition.x}px`,top:`${mousePosition.y}px`}} className={`absolute group/item duration-500 flex items-center justify-center duration-500 top-0 right-0 w-28 h-28 rounded-full ring-1 ring-white/50 hover:ring-white/80 ${showProjects ? 'opacity-0' : 'opacity-100'}`}>
